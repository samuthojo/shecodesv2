<section id="sectionPartners">
    <div class="section-wrapper layout vertical">
        <h3>
            Program Partners
        </h3>
        <div id="thePartners" class="layout inline justified">
            ...
            <a><img class="partner-image"  src="{{asset('images/saharalogo.png')}}" width="60"></a>
            <a><img class="partner-image"  src="{{asset('images/tbi.png')}}" width="60"></a>
        </div>
    </div>
</section>